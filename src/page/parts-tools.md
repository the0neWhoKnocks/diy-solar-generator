...
Since parts/tools and prices change over time, this is mainly a reference of what I used. You should do your own research to ensure you're getting what you need to fit your needs or budget.
...
{% drawer 'Tools', true %}
  ...
  | {% imgPopUp 'mani:imgs/parts/cable-stripper', 'Jonard Tools CST-1900 Round Cable Stripper' %} | [Jonard Tools CST-1900 Round Cable Stripper](https://www.amazon.com/dp/B0069627PA) | For stripping cable jackets off thick gauge wire. |
  | {% imgPopUp 'mani:imgs/parts/hydraulic-crimper', 'TEMCo TH0006 Hydraulic Electrical Cable Lug/Terminal Crimper Kit' %} | [TEMCo TH0006 Hydraulic Electrical Cable Lug/Terminal Crimper Kit](https://www.amazon.com/dp/B00HJXHX1K) | Used to crimp larger connecters on cables.  |
  |<!--{tr:.optional}--> {% imgPopUp 'mani:imgs/parts/crimper-w-wire-cutter', 'Cable Lug Crimper with Wire Cutter' %} | [Cable Lug Crimper with Wire Cutter](https://www.amazon.com/dp/B00MVE48Z6) | Used this until I couldn't crimp some Anderson connector pins, then I got the hydraulic crimper. The wire cutter worked well, but if you already have one you can skip this.|
  | {% imgPopUp 'mani:imgs/parts/10-24awg-ratchet-crimping-tool', '10-24 AWG Ratchet Wire Crimper' %} | [10-24 AWG Ratchet Wire Crimper](https://www.amazon.com/dp/B0BJVH4J6Q) | Crimps connectors to smaller wires. |
  | {% imgPopUp 'mani:imgs/parts/vise', 'MYTEC Clamp-On Vise' %} | [MYTEC Clamp-On Vise](https://www.amazon.com/dp/B07KSQ5V49) | Used for bending lugs and holding on to the cutting board while I cut it to bits. |
  | {% imgPopUp 'mani:imgs/parts/auto-cable-stripper', 'Klein Tools 11063W Automatic Wire Cutter-Stripper' %} | [Klein Tools 11063W Automatic Wire Cutter/Stripper, for 8-20 AWG Solid and 10-22 AWG Stranded Electrical Wire](https://www.amazon.com/dp/B00BC39YFQ) | For stripping cable jackets off smaller gauge wire. |
...
{% drawer 'Parts', true %}
  ...
  | {% imgPopUp 'mani:imgs/parts/12v-battery', '12V 100Ah Mini LiFePO4 Battery' %} | [Redodo 12V 100Ah Mini LiFePO4 Battery (x3)](https://www.amazon.com/dp/B0C7KPJ33Y) | Hook 3 together in array for 300Ah. |
  | {% imgPopUp 'mani:imgs/parts/ac-charger', 'AC Battery Charger' %} | [Redodo 14.6V 40A LiFePO4 AC Battery Charger](https://www.amazon.com/dp/B0CXPGF6KX) | Used for charging the batteries up via AC. |
  | {% imgPopUp 'mani:imgs/parts/terminal-covers', 'Terminal Covers' %} | [2-10 AWG Silicone Terminal Covers](https://www.amazon.com/dp/B08BL4S5YJ) | Used over the top of the Invertor terminals. Also use them when doing maintenance on the battery array to ensure if a cable flopped over on another terminal it wouldn't cause a short. |
  | {% imgPopUp 'mani:imgs/parts/4awg-tinned-copper-lugs', '4 AWG M8 Tinned Copper Lugs' %} | [4 AWG - 5/16" (M8) Tinned Copper Lugs](https://www.amazon.com/dp/B0CWGYGK27) | Lugs for wires to connect to battery. |
  | {% imgPopUp 'mani:imgs/parts/2-8awg-lugs-kit', '2-8 AWG Lugs Kit' %} | [Sanuke 2-8 AWG Lugs Kit](https://www.amazon.com/dp/B08TGK8BKR) | Used for battery cables. Ended up running out of the 4AWG 5/16" and bought the individual ones (which ended up being better), and 2 4AWG 3/8" were used for the Shunt terminals - otherwise you can skip this kit and buy what you need. |
  | {% imgPopUp 'mani:imgs/parts/metal-rods', 'Steel Metal Rods' %} | [Steel Metal Rods](https://www.amazon.com/dp/B07KY99VKY) | Used for bending lugs to the angles I needed. |
  | {% imgPopUp 'mani:imgs/parts/4awg-wire', '4 AWG Wire' %} | [iGreely 4 AWG Wire 10ft Tinned Copper](https://www.amazon.com/dp/B09TQBQYPL) | For wiring up battery array. |
  | {% imgPopUp 'mani:imgs/parts/m8-hex-nuts-bolts', 'M8 Hex Nuts & Bolts' %} | [M8 Hex Nuts & Bolts](https://www.amazon.com/dp/B0CM3KDZZH) | Used to mount 300A fuse to battery. |
  | {% imgPopUp 'mani:imgs/parts/300a-fuse', '300 Amp MEGA Fuse' %} | [Blue Sea Systems 300 Amp MEGA/AMG Fuse](https://www.amazon.com/dp/B000MMC7RU) | Fuse between battery and circuit breaker. |
  |<!--{tr:.optional}--> {% imgPopUp 'mani:imgs/parts/nut-bolt-screw-gauge', 'Nut, bolt, screw gauge' %} | [Nut, bolt, screw gauge](https://www.amazon.com/dp/B01N9C23F5) | Determine what size parts you need in case the sizes aren't apparent. Didn't have this during the build, but wish I did. |
  ...
  |<!--{tr:.optional}--> {% imgPopUp 'mani:imgs/parts/10awg-wire-2', '10 AWG Wire' %} | [Haerkn 10 AWG Wire 10ft Tinned Copper](https://www.amazon.com/dp/B0756TDXJ9) | For wiring components. Bought this on accident. It was stiffer than the other. |
  ...
  | {% imgPopUp 'mani:imgs/parts/10-12awg-anderson-connectors', 'Anderson Connectors' %} | [10-12 AWG Anderson Connectors](https://www.amazon.com/dp/B0B8CP428Z) | Used for connecting solar panels and AC charger. Had to buy these for the pins since I messed up crimping the ones that came with the receptacles. |
  ...
  |<!--{tr:.optional}--> {% imgPopUp 'mani:imgs/parts/magnetic-vent-covers', 'Magnetic vent covers' %} | [Magnetic vent covers](https://www.amazon.com/dp/B0DK9LRCL1) | Cut to fit as cover plates for fans. If you kept the plastic cut out from the case for the fans you may be able to use those instead. |
  |<!--{tr:.optional}--> {% imgPopUp 'mani:imgs/parts/n52-neodymium-magnets', 'N52 Neodymium Magnets' %} | [N52 Neodymium Magnets](https://www.amazon.com/dp/B0D6G4W1H5) | Used to pin cover plate over fans. If you don't care about covers or yours are staying on fine, then skip these. |
  |<!--{tr:.optional}--> {% imgPopUp 'mani:imgs/parts/20a-12awg-power-strip', 'Power Strip' %} | [20A 12 AWG 8-Outlet Metal Power Strip Surge Protector 6ft](https://www.amazon.com/dp/B0D3KVH6RR) | Heavy duty power strip that you can plug multiple items into. Keep in mind that the outlets are standard household 15A and can only deliver so much power before tripping a circuit. |
