const EV_CLOSED=window.CustomDialog.events.closed,ID__IMG="imgPopupImg",ID__POPUP="imgPopup",MODIFIER__CONTAINED="is--contained",MODIFIER__LOADING="is--loading",ROOT_CLASS="img-popup-dialog",SELECTOR__PLUGIN="img-popup",SELECTOR__COUNTER=`${ROOT_CLASS}__counter`,SELECTOR__IMGS=`${ROOT_CLASS}__imgs`,TRANSP_IMG="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7",els={};let imgNdx=0;function addDialog(){document.body.insertAdjacentHTML("beforeend",`
